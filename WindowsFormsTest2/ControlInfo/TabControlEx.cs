...
namespace WindowsFormsTest2.ControlInfo
{
    class TabControlEx : TabControl
    {
        ...
        public TabControlEx()
        {
            ...
            icon = new Bitmap(1, 1);
            tabBackground = WindowsFormsTest2.Properties.Resources.TabButtonBackground;
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = 0; i < this.TabCount; i++)
            {
                ...
                TextFormatFlags format = WindowsFormsTest2.ControlHelper.TextHelper.TabAlignmentToFlag(this.Alignment);
