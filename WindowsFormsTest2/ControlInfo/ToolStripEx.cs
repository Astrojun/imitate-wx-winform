...
namespace WindowsFormsTest2.ControlInfo
{
    ...
    public class ToolStripRendererEx : ToolStripRenderer
    {
        ...
        //ToolStrip、StatusStrip、ContextMenuStrip、MenuStrip
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            if (toolStrip is MenuStrip)  //MenuStrip
            {
                ...
                {
                    using (SolidBrush brush = new SolidBrush(Color.FromArgb(120, Color.Orange)))
                    {
                        g.FillRectangle(brush, clientRectangle);
                    }
                }
        ...
        protected override void OnRenderOverflowButtonBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            {
                ToolStripRendererHelpr.DrawRenderArrow(g, empty, direction, brush);
            }
